...
void SrPostEffectStage::Init()
{
	...
	RTVManager::CreateRenderTargetTexture(.5f, 1.f, "Gauss2ndAfter", true);
	RTVManager::CreateRenderTargetTexture(.5f, .5f, "Gauss3rdAfter", true);
...
void SrPostEffectStage::Render()
{
	...
	BloomP2::Effect("normalTest", "Gauss2ndAfter");
	BloomP3::Effect("Gauss2ndAfter", "Gauss3rdAfter");

	BloomP1::Effect("normalTest", "BloomAfter");
	BloomP2::Effect("BloomAfter", "Bloom2ndAfter");
	BloomP3::Effect("Bloom2ndAfter", "Bloom3rdAfter");


	BloomFin::Effect("normalTest", "Bloom3rdAfter", "CurrentBuffer");
}
